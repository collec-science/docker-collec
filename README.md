...
```
Check the Github repository for a database modification script (in[https://github.com/collec-science/collec-science/tree/master/install/pgsql](https://github.com/collec-science/collec-science/tree/master/install/pgsql)). The script is in the form:
```
alter-1.1-1.2.sql
